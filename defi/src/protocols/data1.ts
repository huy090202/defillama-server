...
const data: Protocol[] = [
  ...
  },
  {
    ...
    dimensions: {
      fees: "sushiswap-classic",
      dexs: "sushiswap-classic"
    }
  },
  /*
  Instadapp wallets
  ...
  */
  ...
  },
  {
    ...
    chain: "Ethereum",
    logo: `${baseIconsUrl}/dforce-lending.jpg`,
    audits: "2",
    gecko_id: null,
    cmcId: null,
    category: "Lending",
  ...
  },
  {
    ...
    dimensions: {
      fees: "kyberswap-classic",
      dexs: "kyberswap-classic"
    }
  },
  {
    id: "128",
  ...
  },
  {
    ...
    gecko_id: "cofix",
    cmcId: "7381",
    tags: ["AMM"], // https://docs.cofix.io/#3.1-price-source
    chains: ["Ethereum"],
    module: "cofix.js",
  ...
  */
  ...
  {
    id: "217",
    name: "Connext", // rebranded to Everclear
  ...
  },*/
  {
    ...
    chain: "Avalanche",
    logo: `${baseIconsUrl}/pangolin-v2.jpg`,
    audits: "3",
    gecko_id: null,
    cmcId: null,
    tags: ["AMM"],
  ...
  // },
  {
    ...
    cmcId: "8299",
    category: "Yield",
    chains: ["Ethereum", "Polygon", "Arbitrum", "Optimism", "Avalanche", "Sonic", "Fraxtal", "Base", "xDai", "Linea"],
  ...
  },
  {
    ...
    chain: "Ethereum",
    logo: `${baseIconsUrl}/parallel-protocol-v2.png`,
    audits: "2",
    gecko_id: null,
    cmcId: null,
    category: "CDP",
  ...
  */
  ...
  },
  {
    ...
    description: "AMM",
    chain: "Solana",
    logo: `${baseIconsUrl}/orca-dex.jpg`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["AMM"],
  ...
  */
  ...
  },
  {
    ...
    dimensions: {
      fees: "flamingo-finance",
      dexs: "flamingo-finance"
    }
  },
  /*
  {
...
*/
  ...
  */
  ...
  },
  {
    ...
    github: ["beefyfinance"],
    // coingecko missing optimism address
    wrongLiquidity: true,
    dimensions: {
      fees: "beefy"
    }
  ...
  },
  {
    ...
    dimensions: {
      fees: "gravity-finance",
      dexs: "gravity-finance"
    }
  },
  {
    id: "352",
...
*/
  ...
  },
  {
    ...
    // https://v3docs.perp.com/perp-v3/docs-for-users/how-perp-v3-works/pyth-oracles
    oraclesBreakdown: [{ name: "Pyth", type: "Primary", proof: [] }],
...
The eWIT token is a custodial, wrapped version of the Witnet coin managed by the WitSwap plaform. The token is minted by the WitSwap team whenever someone wants to convert WIT coins to eWIT tokens and kept in custody. A user on the Ethereum network can also opt to swap his eWIT tokens back to WIT coins. The intent of this token is to allow decentralized trading on Ethereum DEXs and, in the future, to pay independent bridge operators with it if they choose to accept it.`,
  ...
  },
  {
    ...
    gecko_id: null,
    cmcId: null,
    // tvl also counts lending/cdp product
    tags: ["AMM"],
  ...
  },
  {
    ...
    stablecoins: ["mai"],
    // address of qi on optimism is same address as mai on bsc
    wrongLiquidity: true,
    github: ["0xlaozi"],
    dimensions: {
      fees: "qidao"
  ...
  },
  {
    ...
    dimensions: {
      fees: "yield-yak-staked-avax",
      aggregators: "yield-yak"
    }
  },
  {
    id: "476",
...
    referralUrl: "https://www.overtimemarkets.xyz/markets?referrerId=defillama",
  ...
  },
  {
    ...
    //https://maplefinance.gitbook.io/maple/technical-resources/singletons/oracles
    oraclesBreakdown: [{ name: "Chainlink", type: "Primary", proof: [] }],
...
    referralUrl: "https://app.velora.xyz/?ref=MHg3OThmRjFlNkQ3QUZkMjhjMzMzZUU2ZUJlMDMxMjVkMzBlYzZlRjEw", // https://x.com/VeloraDEX/status/2052715943621439728 problems with old url. changed once its fixed - was https://www.velora.xyz
  ...
  },
  {
    id: "906",
    name: "IMPOSSIBLE",
    previousNames: ["Impossible Finance"],
    address: "bsc:0x0b15ddf19d47e6a86a56148fb4afffc6929bcb89",
    symbol: "IDIA",
    url: "https://impossible.finance",
    description:
      "IMPOSSIBLE Research, advisory & AI solutions | Operating Rarible & CURATED.",
    chain: "Binance",
    logo: `${baseIconsUrl}/impossible.jpg`,
    audits: "2",
    gecko_id: "idia",
    cmcId: "10933",
    category: "Launchpad",
...
*/
  ...
  */
  ...
  },
  {
    ...
    //Changed from chainlink to Pyth https://mirror.xyz/0xc730FbdFEb3e9dF76008A19962963cA4A2bd8de2/3fD_61Nf_RQLIe2oGh0Ug9we8b9nxTiMefdw6Q8Tl7g
    oraclesBreakdown: [{ name: "Pyth", type: "Primary", proof: [] }],
    listedAt: 1642780144,
    deadUrl: true,
    dimensions: {
